# Brewbot 🚀☕️
An AI-powered chatbot for coffee shops, integrating LLMs, NLP, and a React Native app for enhanced customer service. This chatbot can assist with taking orders, answering detailed menu queries, and providing personalized product recommendations.
...
# 📂 Directory Structure
```bash
├── BREWBOT/                  # Root directory for the project
│   ├── coffee_app_folder     # Contains React Native app code   
│   ├── python_code
...
## 📜 Research Papers
* [LLMs are Zero-Shot Reasoners](https://arxiv.org/abs/2205.11916): This paper discusses the reasoning capabilities of LLMs with Chain-of-thought prompting and their implications for various applications.
...
* [React Native](https://reactnative.dev/docs/getting-started): React Native Documentation - Official documentation for building mobile applications using React Native.
